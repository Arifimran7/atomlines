...
const Card = ({ heading, paragraph, bgcolor, textColor }) => {
  return (
    <div className="group max-w-sm bg-salt-200 rounded-lg shadow-xl dark:border-gray-700 transition duration-300 ease-in-out hover:bg-gradient-to-r hover:from-teal-500 hover:via-teal-400 hover:to-green-300 hover:text-white text-left px-2 ease-in-out duration-300">
      <div className="p-5">
        <div
