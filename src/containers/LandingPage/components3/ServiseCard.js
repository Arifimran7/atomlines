...
const ServiceCard = ({ icon: Icon, label }) => {
  return (
    <div className="w-full md:w-full lg:w-full mb-4 pr-6 ">
      <div className="flex group items-center rounded bg-white shadow dark:bg-salt-50 md:max-w-full md:flex-row   hover:bg-gradient-to-r hover:from-green-400 hover:via-teal-400 hover:to-teal-300 hover:text-white">
